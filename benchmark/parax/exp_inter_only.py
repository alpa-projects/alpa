...
gpt_inter_only = [
    ...
    (1024, *gpt_specs["39B"],  1,   1,   1,   1,   64, 64,   True,  True,  True,  "uniform_layer_gpipe", _),
    (1024, *gpt_specs["39B"],  1,   1,   1,   1,   64, 128,  True,  True,  True,  "uniform_layer_gpipe", _),
    (1024, *gpt_specs["39B"],  1,   1,   1,   1,   64, 256,  True,  True,  True,  "uniform_layer_gpipe", _),
    (1024, *gpt_specs["39B"],  1,   1,   1,   1,   64, 512,  True,  True,  True,  "uniform_layer_gpipe", _),
