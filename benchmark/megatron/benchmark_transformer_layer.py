...
benchmark_suite_multi_node = [
    ...
    (32,          1024,    1536,        3,          1536//96,  2,       4,              0,),
    (32,          1024,    1536,        3,          1536//96,  1,       8,              0,),

    (32,          128,     5120,        2,          5120//128, 8,       1,              0,),
    (32,          128,     5120,        2,          5120//128, 4,       2,              0,),
    (32,          128,     5120,        2,          5120//128, 2,       4,              0,),
    (32,          128,     5120,        2,          5120//128, 1,       8,              0,),

    (32,          1024,    1536,        3,          1536//96,  8,       1,              1,),
    (32,          1024,    1536,        3,          1536//96,  4,       2,              1,),
    (32,          1024,    1536,        3,          1536//96,  2,       4,              1,),
    (32,          1024,    1536,        3,          1536//96,  1,       8,              1,),

    (32,          128,     5120,        2,          5120//128, 8,       1,              1,),
    (32,          128,     5120,        2,          5120//128, 4,       2,              1,),
    (32,          128,     5120,        2,          5120//128, 2,       4,              1,),
    (32,          128,     5120,        2,          5120//128, 1,       8,              1,),
]
