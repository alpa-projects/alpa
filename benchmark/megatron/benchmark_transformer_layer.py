...
benchmark_suits_single_node = [
    ...
    (16,          1024,    2304,        4,          2304//96,  4,       1,              0,),
    (16,          1024,    2304,        4,          2304//96,  2,       2,              0,),
    (16,          1024,    2304,        4,          2304//96,  1,       4,              0,),

    (16,          256,     3072,        4,          3072//96,  4,       1,              0,),
    (16,          256,     3072,        4,          3072//96,  2,       2,              0,),
    (16,          256,     3072,        4,          3072//96,  1,       4,              0,),
]

benchmark_suits_multi_node = [
    # Batch size, seq_len, hidden size, num_layers, num_heads, dp_size, tensor_mp_size, ddp_impl
    (32,          1024,    2304,        4,          2304//96,  8,       1,              0,),
    (32,          1024,    2304,        4,          2304//96,  4,       2,              0,),
    (32,          1024,    2304,        4,          2304//96,  2,       4,              0,),
    (32,          1024,    2304,        4,          2304//96,  1,       8,              0,),

    (32,          256,     3072,        4,          3072//96,  8,       1,              0,),
    (32,          256,     3072,        4,          3072//96,  4,       2,              0,),
    (32,          256,     3072,        4,          3072//96,  2,       4,              0,),
    (32,          256,     3072,        4,          3072//96,  1,       8,              0,),
]
