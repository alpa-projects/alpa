...
benchmark_suits_single_node = [
    ...
    (32,          1280,    1152,        3,          1152//96,  4,       1,              0,),
    (32,          1280,    1152,        3,          1152//96,  2,       2,              0,),
    (32,          1280,    1152,        3,          1152//96,  1,       4,              0,),
...
benchmark_suits_multi_node = [
    # Batch size, seq_len, hidden size, num_layers, num_heads, dp_size, tensor_mp_size, ddp_impl
    (32,          1280,    1152,        3,          1152//96,  8,       1,              0,),
    (32,          1280,    1152,        3,          1152//96,  4,       2,              0,),
    (32,          1280,    1152,        3,          1152//96,  2,       4,              0,),
    (32,          1280,    1152,        3,          1152//96,  1,       8,              0,),
