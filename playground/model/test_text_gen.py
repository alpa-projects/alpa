...
from examples.opt.serving.wrapper import InferenceFuncOutput, InferenceFuncConfig, WrappedInferenceFunc
...
model = get_model("facebook/opt-30b")
...
for prompt in prompts:
    ...
    generated_ids = model.generate(input_ids=input_ids, max_new_tokens=25, do_sample=False)
