...
clip_model, clip_params = FlaxCLIPTextModel.from_pretrained(
    "/data/wly/stable-diffusion-jax/local_hf/clip-vit-large-patch14", _do_init=False, dtype=dtype
)
...
feature_extractor = AutoFeatureExtractor.from_pretrained("/data/wly/stable-diffusion-jax/local_hf/clip-vit-large-patch14")

tokenizer = CLIPTokenizer.from_pretrained("/data/wly/stable-diffusion-jax/local_hf/clip-vit-large-patch14")
