...
if "gpt" in model_name:
    ...
    raw_model = OPTForCausalLM.from_pretrained(model_name_my_own).to("cuda:0").half()
...
prompts = [
   ...
   "Computers and mobile phones have taken",
    "A chat between a teacher and student who wants to learn about tacos. Teacher: Hi there. What would you like to learn about today? Student:"
]
...
for prompt in prompts:
    ...
    # generated_ids = raw_model.generate(input_ids=input_ids, max_length=128, temperature=0.7, top_p=0.9,
    #                                    )
    # generated_ids = raw_model.generate(input_ids,
    ...
    # with torch.no_grad():
    #     output_0 = raw_model(input_ids)
    generated_ids = raw_model.generate(input_ids, max_new_tokens=2, return_dict_in_generate=True,
    ...
    # generated_string2 = tokenizer.decode(generated_ids[0], skip_special_tokens=True)
