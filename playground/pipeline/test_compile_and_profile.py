...
cost_c1, _, out_spec = compile_and_profile_layer_cost_c((stages[0], stages[3]),
                                                  src_phy_mesh)
cost_c2, in_spec, _ = compile_and_profile_layer_cost_c((stages[1], stages[2]),
                                                 dst_phy_mesh)
...
cost_e = profile_layer_cost_e(stages[0], stages[1], out_spec[0], in_spec[0], src_mesh,
                    dst_mesh, collective_group)
