...
def fwd_berts_jaxpr(bert_config : BertConfig, 
    ...
    batch = {"hidden_states": hidden_states,
              ...
              "label": label,
              "rng": rngkey}
    jaxpr = jax.make_jaxpr(forward)(params, batch)
    return jaxpr, (params, batch)
...
if __name__ == "__main__":
    ...
    # SliceJaxpr(fwd_berts_jaxpr(2)[0], 2)
    # Depth = 4
    ...
    closed_jaxpr, _ = fwd_berts_jaxpr(bert_config, batch_size, seq_len)
