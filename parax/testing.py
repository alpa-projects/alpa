...
from parax.pipeline_parallel.layer_construction import (
    automatic_layer_construction, manual_layer_construction, automatic_remat, manual_remat)
...
def decorate_loss_fn(fn, manual_pipeline, use_remat, layer_num):
    ...
    return automatic_layer_construction(fn, remat_layer=use_remat, layer_num=layer_num)
