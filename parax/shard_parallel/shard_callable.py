...
def shard_parallel_internal_gradient_accumulation(
    ...
    tmp_donate_invars = ((False,) * len(accumulate_grad_invar_indices) + (True,) * num_grads)
    ...
    tmp_donate_invars = (tuple(donated_invars[i] for i in apply_grad_invar_indices) + (False,) * num_grads)
