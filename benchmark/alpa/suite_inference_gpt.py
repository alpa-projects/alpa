    ...
    8: [
        ...
        BenchmarkCase(
            ...
            LoadSolutionParallelArgs(
                ...
                use_remat,
                num_auto_layers=50,
                forward_stage_layer_ids=[list(range(25)), list(range(25, 50))],
                submesh_physical_shapes=[(1, 4)] * 2,
                submesh_logical_shapes=[(1, 4)] * 2,
                submesh_autosharding_option_dicts=[force_dp_dict] * 2)),
    ]
}
