...
from benchmark.alpa.suite_paper_manual_gpt import manual_tuning_gpt_suite, tmp_gpt_suite, gpt_specs
...
def benchmark_all(args):
    ...
    try:
        ...
        exit()
    output_name = f"results_e2e_megatron_{num_gpus}gpus.tsv"
    model = "gpt"
