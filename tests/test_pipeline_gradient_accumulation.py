...
from parax.testing import (MLPModel, BertLayerModel,
                           assert_allclose, create_train_state,get_bert_layer_train_step, get_mlp_train_step)
...
class AccumulateGradTest(unittest.TestCase):
    ...
    def run_n_layer_bert(self,
        ...
        train_step = get_bert_layer_train_step(manual_pipeline_layer, test_remat, n_layers)
