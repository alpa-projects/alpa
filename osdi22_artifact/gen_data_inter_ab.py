...
from benchmark_3d import benchmark_suites
...
if __name__ == "__main__":
    ...
    for benchmark_case in suite:
        if model_type in ["gpt", "bert"]:
            ...
            (batch_size, seq_len, hidden_size, num_layers, num_heads,
             vocab_size, num_experts, expert_group_size, l_dim0, l_dim1, p_dim0,
             p_dim1, pipeline_mp_size, num_micro_batches,
            ...
            (batch_size, image_size, num_layers, num_channels, width_factor,
             ...
             logical_mesh_search_space) = benchmark_case
        ...
        (parameter_count, mem_allocated, max_mem_allocated, latencies, tflops,
         tflops_ckpt, compilation_times, compute_cost_file_name,
        ...
        if pipeline_stage_mode == "uniform_layer_gpipe":
            heads = [
                ...
                "Peak Mem", "overwrite_global_config_dict"
            ]
            parallel_config = (l_dim0, l_dim1, pipeline_mp_size)
            values = [
                model_type, model_config, parallel_config, (p_dim0, p_dim1),
                num_micro_batches, force_batch_dim_mapping, use_remat,
