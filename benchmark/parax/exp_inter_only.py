...
gpt_inter_only = [
    # model,                   LD0, LD1, PD0, PD1, PP, NB,   FM,    Remat, RS,    AP, _
    ...
    (1024, *gpt_specs["2.7B"], 1,   1,   1,   1,   8,  64,   True,  True,  True,  "uniform_layer_gpipe", _),
    (1024, *gpt_specs["2.7B"], 1,   1,   1,   1,   8,  128,  True,  True,  True,  "uniform_layer_gpipe", _),
...
moe_inter_only = [
    ...
    (1024, *moe_specs["690M"], 2048, 1,   1,   1,   1,   2,  128,  True,  True,  True,  False, _),
    (1024, *moe_specs["690M"], 2048, 1,   1,   1,   1,   2,  256,  True,  True,  True,  False, _),
    (1024, *moe_specs["1.3B"], 2048, 1,   1,   1,   1,   4,  64,   True,  True,  True,  False, _),
    (1024, *moe_specs["1.3B"], 2048, 1,   1,   1,   1,   4,  128,  True,  True,  True,  False, _),
    (1024, *moe_specs["1.3B"], 2048, 1,   1,   1,   1,   4,  256,  True,  True,  True,  False, _),
    (1024, *moe_specs["1.3B"], 2048, 1,   1,   1,   1,   4,  512,  True,  True,  True,  False, _),
    (1024, *moe_specs["2.4B"], 2048, 1,   1,   1,   1,   8,  64,   True,  True,  True,  False, _),
    (1024, *moe_specs["2.4B"], 2048, 1,   1,   1,   1,   8,  128,  True,  True,  True,  False, _),
