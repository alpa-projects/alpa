...
if __name__ == "__main__":
    ...
    for epoch in epochs:
        ...
        if training_args.do_train:
            ...
            for i, batch_idx in enumerate(tqdm(training_batch_idx, desc="Training...", position=1)):
                ...
                if i % training_args.logging_steps == 0:
                    epochs.write(f"loss: {np.mean(loss):.2f}\t"
                                 f"lr: {lr_scheduler_fn(optimizer.state.step[0]):.2e}\t"
